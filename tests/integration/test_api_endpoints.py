...
class TestAPIEndpoints:
    ...
    def test_demand_prediction_endpoint(self, client):
        ...
        payload = {"book_id": "BOOK_001", "days_ahead": 7}

        response = client.post(
            "/predict/demand", data=json.dumps(payload), content_type="application/json"
        )
    ...
    def test_recommendations_endpoint(self, client):
        ...
        payload = {"book_id": "BOOK_001", "n_recommendations": 5}

        response = client.post(
            "/recommend/", data=json.dumps(payload), content_type="application/json"
        )
    ...
    def test_batch_prediction_endpoint(self, client):
        ...
        payload = {"book_ids": ["BOOK_001", "BOOK_002", "BOOK_003"], "days_ahead": 5}
