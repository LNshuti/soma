...
class TestModelTrainingPipeline:
    ...
    def db_with_data(self, temp_db_path):
        ...
        books_df = pd.DataFrame({
            ...
            "genre": ["Fiction", "Science", "Biography"] * 34,
            "price": [19.99, 24.99, 29.99] * 34,
            "publication_year": [2020, 2021, 2022] * 34
        })
        ...
        sales_df = pd.DataFrame({
            ...
            "quantity": [1, 2, 3] * 334,
            "unit_price": [19.99, 24.99, 29.99] * 334,
            "total_amount": [19.99, 49.98, 89.97] * 334,
            "customer_type": ["Individual", "Business", "Educational"] * 334
        })
    ...
    def test_recommendation_engine_full_pipeline(self, db_with_data, temp_artifacts_dir):
